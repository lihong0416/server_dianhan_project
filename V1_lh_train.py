...
# 默认值（保持你现在的写法）
DEFAULT_AEQ_INPUT_ROOT = "/mlm/Qingdao/V1"
DEFAULT_OUTPUT_ROOT    = "/mlm/Qingdao/V1"
...
DATA_DIR    = os.getenv("DATA_DIR", os.path.join(AEQ_INPUT_ROOT, "feather_data_v1"))
CACHE_FILE  = os.getenv("CACHE_FILE", os.path.join(OUTPUT_ROOT, "combined_sampled_data_cache.feather"))
