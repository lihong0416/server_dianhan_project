...
# 默认值（保持你现在的写法）
DEFAULT_AEQ_INPUT_ROOT = "/mlm/Qingdao/V3"
DEFAULT_OUTPUT_ROOT    = "/mlm/Qingdao/V3"
...
DATA_DIR    = os.getenv("DATA_DIR", os.path.join(AEQ_INPUT_ROOT, "feather_data_v3"))
CACHE_FILE  = os.getenv("CACHE_FILE", os.path.join(OUTPUT_ROOT, "V3_combined_sampled_data_cache.feather"))
WEIGHTS_PATH = os.getenv("WEIGHTS_PATH", "")  # 你需要权重就传，不需要就空
